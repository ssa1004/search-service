 ...
 *
 * <p>입력 키워드와 편집 거리가 가까운 ES 의 {@code name} 토큰들을 추출하고, 인기도 (clickCount
 * 합산) 로 정렬해 상위 N건 반환.</p>
 */
public interface SuggestRelatedUseCase {
    List<RelatedSuggestion> suggest(SuggestRelatedCommand command);
}
