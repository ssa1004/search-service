 ...
 *
 * 쓰기 (INSERT/UPDATE/DELETE) 는 outbox 와 함께 트랜잭션으로 묶여야 하므로 별도 service 의 책임
 * (PlaceProductService 등) — 현재 도메인 범위에서는 reindex 와 read 용도로만 사용.
 */
interface ProductSourceRepository {
     ...
     * 구현체는 `id` 정렬 + offset 또는 keyset pagination.
     */
    fun findAll(offset: Int, limit: Int): List<Product>
